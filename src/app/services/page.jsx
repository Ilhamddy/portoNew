...
export default function ServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-300 overflow-x-hidden relative">
            ...
            <div key={i} className="group">
              ...
              >
                <div className="flex items-center gap-6 md:gap-10">
                  ...
                  <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tight">{svc.title}</h2>
                </div>
                <Plus
                  size={28}
              ...
              >
                <div className="pb-10 grid grid-cols-1 md:grid-cols-2 gap-10 pl-0 md:pl-24">
      ...
      {/* PROCESS */}
      <section className="relative z-10 py-20 px-6 md:px-12 max-w-7xl mx-auto border-t border-black/10 dark:border-white/10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-px bg-black/10 dark:bg-white/10">
          {process.map((p, i) => (
            <SpotlightCard
              key={i}
              className="bg-white dark:bg-black p-6 group hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300 h-full border border-black/5 dark:border-white/5"
            >
