...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white transition-colors duration-300 overflow-x-hidden relative">
      ...
      {/* BIO SECTION */}
      <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        {/* Left: Profile visual */}
        <div className="relative">
          <div className="relative bg-black dark:bg-zinc-900 aspect-[3/4] max-w-sm overflow-hidden border border-black/10 dark:border-white/10">
            <Image
              src="/profile.jpg"
              alt={personal.name}
              fill
          ...
          <div className="absolute -bottom-4 -right-4 w-full max-w-sm h-full border border-black/15 dark:border-white/15 -z-10" />
          {/* Availability badge */}
          <div className="absolute -top-4 -right-4 bg-black text-white dark:bg-white dark:text-black px-4 py-2 text-xs tracking-widest uppercase font-semibold">
        ...
        <div className="flex flex-col gap-8">
          ...
          {/* Stats row */}
          <div className="grid grid-cols-3 gap-4 border-t border-b border-black/10 dark:border-white/10 py-6">
      ...
      {/* SKILLS */}
      <section className="py-20 px-6 md:px-12 max-w-7xl mx-auto border-t border-black/10 dark:border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-black/15 dark:bg-white/15">
          {skills.map((group) => (
            <div key={group.category} className="bg-white dark:bg-black p-8">
